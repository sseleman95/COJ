...
public class COJ2 {
	public static void main(String[] args) {
		...
		Dog doge_1 = new Dog(Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken()));
		Dog doge_2 = new Dog(Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken()));
